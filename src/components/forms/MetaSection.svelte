<script lang="ts">
  import { currentFormatVersion } from "../../business/CompiledBlock";
...
<Section title="Meta" subtitle="Author information" expanded={true}>
  <div class="mb-4">
    <label
      for="meta-author"
      class="block text-sm font-medium text-gray-900 mb-2">Author</label
    >
    <input
      id="meta-author"
      type="text"
  ...
  <div class="mb-4">
    <label for="meta-type" class="block text-sm font-medium text-gray-900 mb-2"
      >Object Type</label
    >
  ...
  <div class="mb-4">
    <label
      for="meta-version"
      class="block text-sm font-medium text-gray-900 mb-2">Format Version</label
    >
    <input
      id="meta-version"
      type="number"
